document.addEventListener('DOMContentLoaded', function () {
  ...
  function jump() {
    ...
    player.style.bottom = (jumpHeight + parseInt(player.style.bottom || '1%')) + 'px';
...
document.getElementById('game').appendChild(obstacle);
  ...
  function checkCollision(player, obstacle) {
      ...
      let playerWidth = playerRect.width * 0.2; 
      let playerHeight = playerRect.height * 0.2; 
      let obstacleWidth = obstacleRect.width * 0.2; 
      let obstacleHeight = obstacleRect.height * 0.2; 
